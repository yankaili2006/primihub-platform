...
echo ""
echo "数据库初始化："
echo "  如果新部署，执行数据库表初始化："
echo "    mysql -h <mysql_host> -uroot -p<password> privacy < init-privacy-db-tables.sql"
echo ""
echo "Python算法安装："
echo "    ./setup-python-algorithms.sh"
echo ""
echo "如遇问题，请查看文档："
echo "  - USERID_FIX_V2_COMPLETE.md"
echo "  - DEPLOYMENT_GUIDE.md"
echo "  - DEPLOY_KNOWN_ISSUES.md"
echo ""
