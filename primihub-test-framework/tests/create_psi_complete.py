    ...
    if result.get('code') == 0:
        ...
        if projects:
            ...
            psi_params = {
                ...
                "resultOrganIds": organ_id,  # 添加结果接收机构ID
                "outputContent": "0",
                "outputNoRepeat": "1",
            ...
            print(f"   结果接收机构: {psi_params['resultOrganIds']}")
